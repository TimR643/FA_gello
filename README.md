...
> For teleoperation, the Panda gripper uses a close-gesture toggle: fully close the GELLO gripper once to close, release, then fully close again to open. Fully opening the GELLO gripper will also force the real gripper to open. The open/close direction is auto-detected at startup.
