...
# Fenster 3: Wrist Camera / FRAMOS D435e -> onecam 
...
tmux send-keys -t $SESSION:5 "python experiments/run_env.py --agent gello --hostname 127.0.0.1 --wrist-camera-port 5000 --use-save-interface
