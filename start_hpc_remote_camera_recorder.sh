...
LEROBOT_ROOT="${LEROBOT_ROOT:-$HOME/lerobot_data/bottle_task}"
LEROBOT_REPO_ID="${LEROBOT_REPO_ID:-local/bottle_task}"
...
LEROBOT_TASK="${LEROBOT_TASK:-Lift the bottle and put it to the right-hand side space}"
