...
LEROBOT_ROOT="${LEROBOT_ROOT:-$HOME/lerobot_data/push_white_cube_v4}"
LEROBOT_REPO_ID="${LEROBOT_REPO_ID:-local/push_white_cube_v4}"
...
LEROBOT_TASK="${LEROBOT_TASK:-Push the white cube straight forward.}"
