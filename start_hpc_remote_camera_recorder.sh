...
LEROBOT_ROOT="${LEROBOT_ROOT:-$HOME/lerobot_data/pick_2x2_lego}"
LEROBOT_REPO_ID="${LEROBOT_REPO_ID:-local/pick_2x2_lego}"
LEROBOT_FPS="${LEROBOT_FPS:-10}"
LEROBOT_TASK="${LEROBOT_TASK:-pick up the 2x2 lego and go above the necessary height}"
