...
echo "CAMERA_NAMES=${CAMERA_NAMES:-${CAMERAS:-wrist}}"
echo "POLICY_CAMERA_NAMES=${POLICY_CAMERA_NAMES:-camera1,camera2,camera3,empty_camera_0,empty_camera_1}"
...
for episode in $(seq 1 "$NUM_EPISODES"); do
  ...
  lerobot-rollout \
    ...
    --robot.camera_names="${CAMERA_NAMES:-${CAMERAS:-wrist}}" \
    --robot.policy_camera_names="${POLICY_CAMERA_NAMES:-camera1,camera2,camera3,empty_camera_0,empty_camera_1}" \
